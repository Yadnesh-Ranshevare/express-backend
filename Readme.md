# Basic Topics
1. [Express Server Creation](./basics/express/index.js)
2. [Rest API](./basics/RestAPI/index.js)
3. [Data Modeling](./basics/dataModelling/)
4. [Connecting to mongoDb](./basics/mongodbConnectivity/index.js)
5. [Server Side Rendering / EJS](./basics/serverSideRendering/index.js)
6. [bcrypt](./basics/bcrypt/index.js)
7. [Json Web Token](./basics/JWT/index.js)
8. [File Uploading](./basics/fileUploading/index.js)
9. [nodemailer](./basics/nodemailer/Readms.md)
10. [Twilio](./basics/Twilio/index.js)
...
1. [Js Fundamentals](./basics/JavaScriptConcept/jsFundamentals/Readme.md)
2. [Functional Programming Techniques](./basics/JavaScriptConcept/FunctionalProgrammingTechniques/Readme.md)

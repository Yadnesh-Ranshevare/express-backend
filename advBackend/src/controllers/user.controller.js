...
//to get the info on subscriber of the channel
const getUserChannelProfile = asyncHandler (async(req,res)=>{
    ...
    const channel = await User.aggregate([
        ...
        {
            $lookup:{
                from:"subscriptions",        //as all field convert into lowercase and puler
                localField: "_id",
    ...
    .status(200)
    .json(
        new ApiResponse(200,channel[0],"User channel fetched sussfully")
    )
})
...
const getWatchHistory = asyncHandler(async (req,res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200,user[0].watchHistory,"watch history fetch sussfully")
    )
})
export { 
    registerUSer,
